      ...
      >
        <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-black text-white mb-2 tracking-tight">הצטרפו אלינו</h1>
            <p className="text-slate-400 text-sm">צרו חשבון כדי להתחיל לקנות בסטייל</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 mr-2 uppercase tracking-widest">שם מלא</label>
              <div className="relative group">
                ...
                />
                <User className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-500 group-focus-within:text-amber-400 transition-colors" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 mr-2 uppercase tracking-widest">סיסמה</label>
              <div className="relative group">
                <input
                  name="password"
          ...
          <p className="text-center text-slate-500 text-sm mt-8">
            כבר יש לכם חשבון?{" "}
            <Link href="/login" prefetch={false} className="text-amber-400 hover:text-amber-300 font-bold transition-colors">
              התחברו כאן
            </Link>
          </p>
